                ...
                <footer className="py-5">
                    ...
                    <div className="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
                        ...
                        <ul className="list-unstyled d-flex">
                            ...
                            <i class="fa-brands fa-facebook fa-beat-fade text-primary fs-2"></i>
                            </Link>
                            </li>
                            <li className="ms-3"><Link className="link-body-emphasis" to="#">
                            <i class="fa-brands fa-instagram fa-beat-fade text-danger fs-2"></i>
                                </Link></li>
                            <li className="ms-3"><Link className="link-body-emphasis" to="#">
                            <i class="fa-brands fa-twitter fa-beat-fade text-info fs-2"></i>
                            </Link></li>
                        </ul>
                    </div>
                </footer>
